...
export async function approveReservation(batchId, reservationId, ctx = {}) {
  return mutate({
    ...
    mutator: (db) => {
      ...
      const available = batch.quantity - batch.frozenQuantity - (batch.inTransitQuantity || 0);
      ...
      return {
        ...
        availableQuantity: batch.quantity - batch.frozenQuantity - (batch.inTransitQuantity || 0)
      };
    }
  });
}
